...
sudo $aptbin -y install nginx-full nginx-doc apache2-utils fcgiwrap
#sudo $aptbin -y install nginx-passenger 
sudo $aptbin -y install php5 php5-apc php-pear php5-cgi php5-cli php5-fpm php5-dev php5-curl php5-gd php5-imagick php5-imap php5-intl php5-mcrypt php5-sqlite php5-xdebug php5-xmlrpc php5-xsl imagemagick libmagickcore-dev libmagickwand-dev
#sudo $aptbin -y install php5-apc
sudo $aptbin -y install php5-apcu
...
sudo pear install phpdoc/phpDocumentor-beta
